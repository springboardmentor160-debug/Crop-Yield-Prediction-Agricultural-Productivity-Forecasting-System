...
import type { ModelPerformanceResponse } from "@/lib/types";

export default function AdminModelPage() {
    const router = useRouter();

    const [model, setModel] = useState<ModelPerformanceResponse | null>(null);
                ...
                {loading ? (
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {model?.features ? "XGBoost" : "YieldSense AI"}
                            </div>
                        </div>
                        ...
                        >
                            ...
                            >
                                {model?.features ? "XGBoost" : "XGBoost"}
                            </div>
                        </div>
