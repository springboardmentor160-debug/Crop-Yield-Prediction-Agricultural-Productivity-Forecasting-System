...
def train():
    ...
    data_path = "app/data/processed/cleaned_crop_yield.csv"
    if not os.path.exists(data_path):
        data_path = "app/data/raw/kaggle_crop_yield.csv"
        if not os.path.exists(data_path):
            data_path = "app/data/processed/crop_yield_clean.csv"
            if not os.path.exists(data_path):
                data_path = "app/data/raw/crop_yield_raw.csv"
                if not os.path.exists(data_path):
                    print("ERROR: No dataset found!")
                    print("Files checked:")
                    print("  - app/data/processed/cleaned_crop_yield.csv")
                    print("  - app/data/raw/kaggle_crop_yield.csv")
                    return
