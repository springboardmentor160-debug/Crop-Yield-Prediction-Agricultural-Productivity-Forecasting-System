...
export default function GISPage() {
  ...
  const [soilZones, setSoilZones] = useState<any[]>([]);
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                  ...
                  {farms.map((farm) => (
                    <div key={farm.id} onClick={() => setSelectedFarm(farm)}
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px" }}>
                        <div style={{ fontSize: "13px", fontWeight: 600 }}>🏡 {farm.name}</div>
                        <span style={{ fontSize: "10px", color: riskColor(farm.risk_level), backgroundColor: `${riskColor(farm.risk_level)}15`, borderRadius: "100px", padding: "2px 8px" }}>{farm.risk_level} Risk</span>
                      </div>
                      <div style={{ fontSize: "11px", color: "#4a7a4a", marginBottom: "6px" }}>📍 {farm.location}</div>
            ...
            {stations && (
              <div style={{ backgroundColor: "#0d1a0d", border: "1px solid #1a2e1a", borderRadius: "16px", padding: "20px" }}>
                ...
                {stations.weather_stations?.map((s: any, i: number) => (
                ...
                {stations.soil_labs?.map((s: any, i: number) => (
            ...
            {selectedFarm && (
              <div style={{ backgroundColor: "#0d1a0d", border: "1px solid #1a2e1a", borderRadius: "16px", padding: "24px" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "16px" }}>
                  ...
                  <span style={{ fontSize: "13px", color: riskColor(selectedFarm.risk_level), backgroundColor: `${riskColor(selectedFarm.risk_level)}15`, border: `1px solid ${riskColor(selectedFarm.risk_level)}30`, borderRadius: "8px", padding: "6px 14px", fontWeight: 700, alignSelf: "flex-start" }}>
                    {selectedFarm.risk_level} Risk
                  </span>
                </div>
